...
export const sampleAdaptedIssue: AdaptedIssue = {
  ...
  branchName: 'fix/cart-123/fix-checkout-button-not-responding-on-mobile',
  issueType: 'fix',
  jiraLink: 'https://test.atlassian.net/browse/CART-123',
  storyPoints: 3,
  slug: 'cart-123-fix-checkout-button-not-responding-on-mobile'
};
